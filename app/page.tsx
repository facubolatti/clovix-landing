...
export default function Home() {
  return (
    <div className="flex flex-col flex-1">
      ...
      {/* Preguntas */}
      <section id="por-que-clovix" className="bg-clovix-black px-6 py-24">
      ...
      {/* Módulos */}
      <section id="modulos" className="bg-clovix-gray-light px-6 py-24">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-center text-3xl font-bold text-clovix-black sm:text-4xl">
            Módulos
          </h2>
      ...
      <footer className="border-t border-black/5 px-6 py-10">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 sm:flex-row">
          <Image src="/logo.png" alt="Clovix" width={100} height={28} />
