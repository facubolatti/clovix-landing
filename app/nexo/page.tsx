  ...
  return (
    <>
        ...
        <div className="hero-grid" style={{alignItems: 'center'}}>
          ...
          <div className="stage win-flat rv">
            <div className="win" style={{boxShadow: 'var(--shadow-lg)'}}>
              <div className="win-bar"><i></i><i></i><i></i><span className="win-url">Recordatorio automático · la respuesta la escribe tu centro</span></div>
              <div style={{background: '#ECE5DD', padding: '14px', display: 'flex', flexDirection: 'column', gap: '9px'}}>
      <div style={{maxWidth: '82%', padding: '8px 11px', borderRadius: '12px', borderTopRightRadius: '3px', fontSize: '.72rem', lineHeight: '1.45', background: '#D9FDD3', alignSelf: 'flex-end', boxShadow: '0 1px 1px rgba(0,0,0,.08)'}}>Hola Sofía 👋 Te recordamos tu turno de mañana a las 10:00 con Malena.<br />Si necesitás cancelar o reprogramar, escribinos por este medio. ¡Te esperamos!<span style={{display: 'block', fontSize: '.58rem', color: '#8696A0', textAlign: 'right', marginTop: '3px'}}>09:02 ✓✓</span></div>
      <div style={{maxWidth: '82%', padding: '8px 11px', borderRadius: '12px', borderTopLeftRadius: '3px', fontSize: '.72rem', background: '#fff', alignSelf: 'flex-start', boxShadow: '0 1px 1px rgba(0,0,0,.08)'}}>Gracias! Se puede pagar con transferencia?<span style={{display: 'block', fontSize: '.58rem', color: '#8696A0', textAlign: 'right', marginTop: '3px'}}>09:14</span></div>
      <div style={{maxWidth: '82%', padding: '8px 11px', borderRadius: '12px', borderTopRightRadius: '3px', fontSize: '.72rem', background: '#D9FDD3', alignSelf: 'flex-end', boxShadow: '0 1px 1px rgba(0,0,0,.08)'}}>Sí, te paso el alias al confirmar la seña 💳<span style={{display: 'block', fontSize: '.58rem', color: '#8696A0', textAlign: 'right', marginTop: '3px'}}>09:14 ✓✓</span></div>
      <div style={{maxWidth: '82%', padding: '8px 11px', borderRadius: '12px', borderTopLeftRadius: '3px', fontSize: '.72rem', background: '#fff', alignSelf: 'flex-start', boxShadow: '0 1px 1px rgba(0,0,0,.08)'}}>Genial, gracias!<span style={{display: 'block', fontSize: '.58rem', color: '#8696A0', textAlign: 'right', marginTop: '3px'}}>09:15</span></div>
      <div style={{maxWidth: '82%', padding: '8px 11px', borderRadius: '12px', borderTopRightRadius: '3px', fontSize: '.72rem', background: '#D9FDD3', alignSelf: 'flex-end', boxShadow: '0 1px 1px rgba(0,0,0,.08)'}}>Te esperamos 😊<span style={{display: 'block', fontSize: '.58rem', color: '#8696A0', textAlign: 'right', marginTop: '3px'}}>09:15 ✓✓</span></div>
      </div>
            </div>
          </div>
        </div>
      ...
      <div className="wrap">
        ...
        <h3>Independiente</h3>
        <div className="price">$75.000<small>/mes</small></div>
        ...
        <h3>Inicial</h3>
        <div className="price">$105.000<small>/mes</small></div>
        ...
        <div className="plan-lim"><span className="chip">3 profesionales</span><span className="chip">500 turnos/mes</span><span className="chip">1.300 notificaciones/mes</span></div>
        <a href={NEXO_SIGNUP} className="btn btn-ink">Empezar gratis</a>
      </div><div className="plan top rv"><span className="plan-flag">Más elegido</span>
        <h3>Profesional</h3>
        <div className="price">$140.000<small>/mes</small></div>
        ...
        <h3>Premium</h3>
        <div className="price">$180.000<small>/mes</small></div>
        <div className="plan-cap">El centro grande o con foco clínico</div>
        <div className="plan-destacado">Dos sedes incluidas y el mayor volumen de cupos</div>
        <div className="plan-lim"><span className="chip">12 profesionales</span><span className="chip">3.000 turnos/mes</span><span className="chip">8.000 notificaciones/mes</span></div>
        <a href={NEXO_SIGNUP} className="btn btn-ink">Empezar gratis</a>
      </div></div>
        ...
        <div className="tabla-wrap rv">
          <table className="cmp">
            ...
            <tbody>
              ...
              <tr><td>Turnos por mes</td><td>250</td><td>500</td><td>1.500</td><td>3.000</td></tr>
              <tr><td>Sedes incluidas</td><td>1</td><td>1</td><td>1</td><td>2</td></tr>
              <tr><td>Notificaciones por mes <span style={{opacity:.6}}>(WhatsApp o app)</span></td><td>700</td><td>1.300</td><td>4.000</td><td>8.000</td></tr>
        ...
        <div className="planes-pie rv">
          ...
          <p><strong>Precios vigentes a septiembre de 2026.</strong> Los ajustes se avisan con treinta días de anticipación, rigen desde el período siguiente y nunca son retroactivos.</p>
        </div>
      </div>
