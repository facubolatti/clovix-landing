  ...
  return (
    <>
      ...
      <div className="wrap">
        ...
        <div className="plan-lim"><span className="chip">1 profesional</span><span className="chip">250 turnos/mes</span><span className="chip">500 notificaciones/mes</span></div>
        ...
        <div className="plan-lim"><span className="chip">6 profesionales</span><span className="chip">1.500 turnos/mes</span><span className="chip">2.500 notificaciones/mes</span></div>
        <a href={NEXO_SIGNUP} className="btn btn-grad">Empezar gratis</a>
      </div><div className="plan  rv">
        <h3>Premium</h3>
        ...
        <div className="plan-lim"><span className="chip">12 profesionales</span><span className="chip">turnos sin tope</span><span className="chip">5.000 notificaciones/mes</span></div>
        <a href={NEXO_SIGNUP} className="btn btn-ink">Empezar gratis</a>
      </div></div>
        ...
        <div className="tabla-wrap rv">
          <table className="cmp">
            ...
            <tbody>
              ...
              <tr><td>Notificaciones por mes <span style={{opacity:.6}}>(WhatsApp o app)</span></td><td>500</td><td>1.300</td><td>2.500</td><td>5.000</td></tr>
